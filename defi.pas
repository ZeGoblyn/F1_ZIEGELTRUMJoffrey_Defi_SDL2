...
//SDL et SDL 2.0: Language de programmation développer pour gérer les visuel 2D et 3D.
//La différence entre les deux version du programme repose majoritairement sur les possibilitées offertes
